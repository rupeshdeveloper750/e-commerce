    ...
    <div class="overflow-hidden rounded-3xl border border-gray-200 dark:border-slate-800 bg-white dark:bg-[#111827] shadow-sm dark:shadow-xl transition-colors duration-300">
        ...
        <div class="flex items-center justify-between border-b border-gray-200 dark:border-slate-800 px-6 py-5">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500 dark:text-slate-400">Track shipments, verify card clearances and process refunds.</p>
            </div>
            <div class="rounded-xl border border-gray-200 dark:border-slate-700 bg-gray-50 dark:bg-slate-800 px-4 py-2 text-sm text-gray-600 dark:text-slate-300">
                Total : <span class="font-semibold text-gray-900 dark:text-white">{{ $orders->total() }}</span>
            </div>
        </div>
            ...
            <table class="min-w-full">
                <thead class="border-b border-gray-200 dark:border-slate-800 bg-gray-50 dark:bg-slate-900">
                    <tr>
                        ...
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-slate-300">Order Number</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-slate-300">Customer</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-slate-300">Total</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-slate-300">Order Status</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-slate-300">Payment Status</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-slate-300">Method</th>
                        <th class="px-6 py-4 text-left text-sm font-semibold text-gray-600 dark:text-slate-300">Placed At</th>
                        <th class="px-6 py-4 text-center text-sm font-semibold text-gray-600 dark:text-slate-300">Action</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-100 dark:divide-slate-800">
                    @forelse ($orders as $order)
                        <tr class="hover:bg-gray-50 dark:hover:bg-slate-900/40 transition {{ $order->trashed() ? 'bg-red-50/50 dark:bg-red-950/5' : '' }}">
                            <td class="px-6 py-4">
                                <input
                                    type="checkbox"
                                    :value="{{ $order->id }}"
                            ...
                            <td class="px-6 py-4 text-sm font-bold text-gray-900 dark:text-white tracking-wider">
                            ...
                            <td class="px-6 py-4 text-sm text-gray-700 dark:text-slate-200">
                                {{ $order->first_name }} {{ $order->last_name }}
                                <div class="text-xs text-gray-400 dark:text-slate-500 mt-0.5">{{ $order->email }}</div>
                            </td>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500 dark:text-slate-400 uppercase">
