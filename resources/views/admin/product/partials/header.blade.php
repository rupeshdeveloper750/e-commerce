<div x-data="{ showImport: false }" class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
    ...
    <div>
        ...
        <nav class="mb-3 flex items-center gap-2 text-sm">
            ...
            <span class="text-gray-400">/</span>
            <span class="font-medium text-[#B88A44]">Products</span>
        </nav>
        ...
        <p class="mt-2 text-sm text-gray-500 dark:text-slate-400">
            Create products, configure custom variants, check stock levels and publish items.
        </p>
    </div>
    ...
    >
        <div class="flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
                <div>
                    <h3 class="text-lg font-bold text-white">Import Products from CSV</h3>
                    <p class="mt-1 text-sm text-slate-400">Upload a CSV file containing product entries.</p>
                </div>
