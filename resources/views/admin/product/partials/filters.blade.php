<div class="rounded-3xl border border-slate-800 bg-[#111827] p-6 shadow-xl">
    <form action="{{ route('admin.products.index') }}" method="GET">
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-12">
            ...
            {{-- Brand --}}
            <div class="lg:col-span-2">
                <label class="mb-2 block text-sm font-semibold text-slate-300">Brand</label>
                <select
                    name="brand_id"
                    class="h-14 w-full rounded-2xl border border-slate-700 bg-slate-800 px-4 text-white transition-all duration-300 focus:border-[#B88A44] focus:ring-4 focus:ring-[#B88A44]/20">
            ...
            <div class="lg:col-span-3">
                <div class="grid grid-cols-2 gap-3">
                    <div>
                        ...
                        <select
                            name="status"
                            class="h-14 w-full rounded-2xl border border-slate-700 bg-slate-800 px-4 text-xs text-white transition-all duration-300 focus:border-[#B88A44] focus:ring-4 focus:ring-[#B88A44]/20">
                    ...
                    <div>
                        <label class="mb-2 block text-sm font-semibold text-slate-300">Stock</label>
                        <select
                            name="stock_level"
                            class="h-14 w-full rounded-2xl border border-slate-700 bg-slate-800 px-4 text-xs text-white transition-all duration-300 focus:border-[#B88A44] focus:ring-4 focus:ring-[#B88A44]/20">
                            <option value="">All</option>
