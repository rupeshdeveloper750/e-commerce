<div x-data="{ showImport: false }" class="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
    ...
    <div class="flex flex-wrap items-center gap-3">
        ...
        <button
            ...
            class="inline-flex h-12 items-center gap-2 rounded-xl border border-slate-700 bg-slate-800 px-5 text-sm font-semibold text-slate-300 transition hover:bg-slate-705"
        >
    ...
    >
        <div class="flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
            ...
            >
                <div>
                    <h3 class="text-lg font-bold text-white">Import Categories from CSV</h3>
                    <p class="mt-1 text-sm text-slate-400">Upload a CSV file containing categories structure.</p>
                </div>
