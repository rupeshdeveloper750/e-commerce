    ...
    <form action="{{ route('admin.categories.index') }}" method="GET">
        <div class="grid grid-cols-1 gap-5 lg:grid-cols-12">
            ...
            <div class="lg:col-span-3">
                <label class="mb-2 block text-sm font-semibold text-slate-300">Parent Category</label>
                <select
                    name="parent_id"
                    ...
                    <option value="null" {{ request('parent_id') === 'null' ? 'selected' : '' }}>Root Categories Only</option>
        ...
        <div class="mt-8 flex flex-col gap-4 border-t border-slate-800 pt-6 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center gap-3">
                <select
                    ...
                    <option value="sort_order" {{ request('sort_by') === 'sort_order' ? 'selected' : '' }}>Sort by Sort Order</option>
