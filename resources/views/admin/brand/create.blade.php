...
<div class="mx-auto max-w-screen-2xl px-4 py-6 sm:px-6 lg:px-8">
    <div class="mb-6 flex flex-col gap-1 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <h1 class="mt-1 text-2xl font-bold tracking-tight text-white">Add Brand</h1>
            <p class="mt-1 text-sm text-slate-400">Create a new manufacturer brand for your store catalog.</p>
        </div>
    </div>
