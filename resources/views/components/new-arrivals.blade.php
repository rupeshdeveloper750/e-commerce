...
<section class="w-full py-16 bg-stone-50 border-y border-[#E5E7EB]/80" aria-labelledby="new-arrivals-heading">
    <div class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 space-y-10 md:space-y-12">
        
        {{-- Section Header --}}
        <div class="flex flex-col sm:flex-row sm:items-end justify-between gap-4 border-b border-gray-200 pb-6">
            <div class="space-y-2">
                <span class="text-[10px] font-bold uppercase tracking-widest text-[#B88A44] block">Just Landed</span>
                <h2 id="new-arrivals-heading" class="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-[#111827] tracking-tight">New Arrivals</h2>
                <p class="text-xs text-gray-500 font-medium">Fresh from the atelier, updated weekly</p>
            </div>
        ...
        {{-- Product Grid (Non-scrolling 4-column layout) --}}
                ...
                <li class="group relative flex flex-col justify-between rounded-2xl border border-[#E5E7EB]/60 bg-white p-4 hover:shadow-xl hover:border-transparent transition-all duration-300">
                    ...
                    <div class="aspect-[3/4] w-full rounded-xl overflow-hidden relative bg-gray-50 border border-gray-150/40">
                        ...
                        <div class="absolute top-3 left-3 z-10 flex flex-col gap-1.5">
                            {{-- Outlined New Badge with Subtle Pulsing --}}
                            <span class="inline-flex items-center gap-1 rounded border border-[#B88A44] bg-white/95 backdrop-blur-sm px-2.5 py-0.5 text-[8px] font-bold text-[#B88A44] uppercase tracking-widest shadow-sm">
                                <span class="w-1.5 h-1.5 rounded-full bg-[#B88A44] animate-pulse"></span>
                                New
                            </span>
                        </div>
                    ...
                    <div class="pt-4 space-y-1.5 flex-grow flex flex-col justify-between">
                        <div class="space-y-1">
                            ...
                            @if($product->created_at->gt(now()->subDays(7)))
                                <span class="block text-[9px] font-bold text-[#B88A44] tracking-wide uppercase">New This Week</span>
                            @endif
                        </div>

                        {{-- Pricing and Stock --}}
                        <div class="pt-3 border-t border-gray-150 flex items-center justify-between mt-3">
